...
<html>
    <head>
        ...
        <title><?php echo xlt('KPI Report'); ?></title>

        <?php Header::setupHeader(['datetime-picker', 'report-helper']); ?>

        <script>
            function submitForm() {
                const fromDate = $("#form_from_date").val();
                const toDate = $("#form_to_date").val();
    ...
    <body class="body_top">
        <span class='title'><?php echo xlt('Key Process Indicator Report'); ?></span>
        ...
        <div id="report_results" style="font-size: 12px">
            ...
            <table class="table table-striped" id="ds_report">
