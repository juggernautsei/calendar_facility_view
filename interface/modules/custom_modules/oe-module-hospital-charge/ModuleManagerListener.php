...
class ModuleManagerListener extends AbstractModuleActionListener
{
    ...
    public static function getModuleNamespace(): string
    {
        ...
        return 'Juggernaut\\Module\\HospitalCharge\\';
    }
    ...
    {
        $logMessage = 'Hospital Charge Background tasks have been enabled';
    ...
    private function unregister($modId, $currentActionStatus): mixed
    {
         ...
         */
        $logMessage = 'Hospital Charge background services have been removed'; // Initialize an empty string to store log messages
        return $currentActionStatus;
    }
