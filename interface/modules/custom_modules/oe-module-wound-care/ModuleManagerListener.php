...
class ModuleManagerListener extends AbstractModuleActionListener
{
    ...
    public static function getModuleNamespace(): string
    {
        ...
        return 'Juggernaut\\Module\\WoundCare\\';
    }
    ...
    private function unregister($modId, $currentActionStatus)
    {
        ...
        $sql = "DROP TABLE IF EXISTS `module_wound_care_settings`";
        sqlStatement($sql);
        $sql = "DROP TABLE IF EXISTS `wound_assessments`";
        sqlStatement($sql);
        $sql = "DROP TABLE IF EXISTS `wound_treatment_plans`";
        sqlStatement($sql);
